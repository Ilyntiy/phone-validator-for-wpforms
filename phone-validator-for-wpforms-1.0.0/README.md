...
Check the **"Validation History"** submenu to see a detailed log of all blocked submissions and validation errors.
...
![General Settings](https://via.placeholder.com/800x400?text=Settings+Screenshot)
*Configure length limits, country codes, and spam protection rules*

![Validation History](https://via.placeholder.com/800x400?text=Logs+Screenshot)
...
**advertsales**  
📧 Support: [Telegram](https://t.me/yourusername)
